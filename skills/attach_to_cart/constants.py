...
ERROR_CART_STILL_ATTACHED = (12, 'cart is still attached')

# Rotating

ROTATING_DISTANCE = 30.0
ROTATING_DISTANCE_AV = 20.0
ROTATING_ANGLE_MIN = 4.0
ROTATING_CONST = 100.0
ROTATING_ANGULAR_SPEED = 30.0
ROTATION_KP = 0.7
MIN_STARTING_ANGLE = 4.0
...
SRF_M2CM = 100.0
ATTACH_VERIFICATION_DISTANCE = 1.2
DETACH_VERIFICATION_DISTANCE = 4.0
...
PUSHING_IDENTIFIER_DISTANCE = 10.0
PUSHING_IDENTIFIER_DELTA = 0.05
...
#GRIPPER CODE FEEDBACK
CART_NOT_ATTACHED_CODE = 5
TOUCHING_OBJECT_CODE = 3
REACHED_OPEN_POSE_CODE = 2
REACHED_CLOSE_POSE_CODE = 1
...
FULL_APP_TIMEOUT = 75.0
DETACH_TIMEOUT = 30.0
MOVING_BACK_TIMEOUT = 35.0
DEBUG = False
DEFAULT_ROTATING_180 = False
DEFAULT_LEDS_INTERACTIONS = True
DEFAULT_DEBUG_LEVEL = False

# TODO changes for current cart gripper execute : 
# GRIPPER_VELOCITY, GRIPPER_OPEN_POSITION, GRIPPER_CLOSE_POSITION
